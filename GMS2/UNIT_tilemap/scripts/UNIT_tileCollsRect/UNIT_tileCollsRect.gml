...
function UNIT_tileCollsRect(
	...
	_callbackCheck=__UNIT_tileFunctorId, _callbackData, 
...
/// @function		UNIT_tileCollsRectList(tilemap_element_id, x1, y1, x2, y2, list, [callback_check=FunctorId], [callback_data], [offset_x=tilemap_get_x], [offset_y=tilemap_get_y]);
function UNIT_tileCollsRectList(
...
/// @function		UNIT_tileCollsRectInst(tilemap_element_id, inst, [inst_x=inst.x], [inst_y=inst.y], [callback_check=FunctorId], [callback_data], [offset_x=0], [offset_y=0]);
function UNIT_tileCollsRectInst(
