...
self.tests[$ "0"] = {
	...
	test: function() {
		...
		var _colls = UNIT_tileCollsRectList(root.tilemap, _x1, _y1, _x2, _y2, self.list, root.check, 
...
self.tests[$ "1"] = {
	...
	test: function() {
		...
		var _colls = UNIT_tileCollsRectInst(root.tilemap, self.inst, mouse_x, mouse_y,
